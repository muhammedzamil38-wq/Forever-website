    ...
    <div>
      ...
      <div className="my-10 flex flex-col justify-center md:flex-row gap-10 mb-28">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <p className='text-gray-500'>670594 Vanidas St <br /> Vara Elayavoor Kannur ,Kerala India</p>
          <p className='text-gray-500'>Tel: (+91) 7993647879 <br /> Email: achar@gmail.com</p>
